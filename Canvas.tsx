...
const Canvas: React.FC<CanvasProps> = ({ displayImageUrl, isLoading, loadingMessage, onSelectPose, poseInstructions, currentPoseIndex, availablePoseKeys }) => {
  ...
  return (
    <div className="w-full flex items-center justify-center p-4 relative animate-zoom-in group">
      ...
      <div className="relative w-full flex items-center justify-center">
        {displayImageUrl ? (
          <img
            ...
            className="w-full h-auto object-contain rounded-lg transition-opacity duration-500 animate-fade-in max-h-[calc(100vh-260px)] md:max-h-[calc(100vh-220px)] lg:max-h-[calc(100vh-240px)]"
          />
        ) : (
