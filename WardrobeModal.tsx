...
const WardrobePanel: React.FC<WardrobePanelProps> = ({ onGarmentSelect, activeGarmentIds, isLoading, wardrobe }) => {
  ...
  return (
    <div className="wardrobe pt-6 border-t border-gray-400/50">
        <h2 className="text-xl font-serif tracking-wider mb-3" style={{ color: '#A4823F' }}>Wardrobe</h2>
        <p className="text-sm text-gray-600 mb-4">
            Upload your desired outfit or fashion item you’ve found online to try it on virtually.
        </p>
        <div className="grid grid-cols-3 gap-3">
            ...
            <label htmlFor="custom-garment-upload" className={`relative aspect-square border-2 border-dashed rounded-lg flex flex-col items-center justify-center text-gray-500 transition-colors ${isLoading ? 'cursor-not-allowed bg-gray-100' : 'cursor-pointer hover:border-gray-400 hover:text-gray-600'}`}>
