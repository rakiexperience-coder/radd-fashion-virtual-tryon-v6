...
const OutfitStack: React.FC<OutfitStackProps> = ({ outfitHistory, onRemoveLastGarment }) => {
  return (
    <div className="flex flex-col">
      <h2 className="text-xl font-serif tracking-wider border-b border-gray-400/50 pb-2 mb-3" style={{ color: '#A4823F' }}>Outfit Stack</h2>
        ...
        {outfitHistory.map((layer, index) => (
          ...
          >
            <div className="flex items-center overflow-hidden">
                ...
                <span 
                  className={`font-semibold truncate ${layer.garment ? 'text-gray-800' : 'text-[#A4823F]'}`}
                  title={layer.garment?.name || 'Base Model'}
                >
